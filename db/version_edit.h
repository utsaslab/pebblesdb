...
namespace leveldb {
    ...
    struct FileMetaData {
        ...
        uint64_t number;            // SSTables names (i.e. number.sst)
...
*/
    ...
    // Can be think of as: Version0 + VersionEdit = Version1 (i.e. VersionEdit 代表一次更新，新增了哪些sstable file，以及删除了哪些sstable file)
    // Ref: http://bean-li.github.io/leveldb-version/
    // http://www.d-kai.me/levedb-2-%E6%95%B4%E4%BD%93%E6%9E%B6%E6%9E%84/
    class VersionEdit {
    public:
        VersionEdit()
                : comparator_(),
    ...
    private:
        ...
        // 第二个和第三个顾名思义，就是相对于上一个Version，新的Version新增了那些文件以及删除了那些文件。
